...
- Runtime use: fixed 78×48 px crop at `(42,36)` rendered at 0.5× with a stable foot pivot.
...
This is the sole player sprite family. Missing Summing-specific traversal poses use documented nearest-state mappings in `TemplatePlayerRenderer`; collision remains the authoritative 18×22 px one-tile body.
