...
public static class MaterialCatalog
{
    private static readonly IReadOnlyDictionary<MaterialId, MaterialDefinition> Definitions =
        new Dictionary<MaterialId, MaterialDefinition>
        {
            ...
            [MaterialId.RedSandstone] = new(MaterialId.RedSandstone, "red sandstone", true, 2, 0.82f, 0.55f, 0.32f, 0.12f, true, true,
                new(111, 60, 61), new(161, 88, 70)),
            [MaterialId.BlackBasalt] = new(MaterialId.BlackBasalt, "black basalt", true, 5, 0.94f, 0.12f, 0.48f, 0.34f, true, true,
                new(48, 45, 55), new(78, 66, 69)),
            [MaterialId.FossilComposite] = new(MaterialId.FossilComposite, "fossil composite", true, 3, 0.77f, 0.38f, 0.24f, 0.43f, true, true,
                new(119, 106, 84), new(177, 151, 105)),
            [MaterialId.RuinAlloy] = new(MaterialId.RuinAlloy, "votive alloy", true, 7, 0.9f, 0.08f, 0.7f, 0.92f, true, true,
            ...
            [MaterialId.SaltGlass] = new(MaterialId.SaltGlass, "salt glass", true, 2, 0.55f, 0.92f, 0.12f, 0.62f, false, false,
