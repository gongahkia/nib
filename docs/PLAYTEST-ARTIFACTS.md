...
- `events.jsonl`: frame-linked events for damage/death/fall, successful dash starts, terrain damage/destruction, directional tool strikes, successful or rejected rope placement, bomb explosions and outer-edge rocket jumps, burrower interactions, brittle triggers/collapse, relic collection, visual-pack changes, manual playtest bookmarks, and summit completion.
